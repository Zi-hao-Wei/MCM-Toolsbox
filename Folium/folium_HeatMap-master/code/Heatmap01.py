...
df = pd.read_csv("C:\\Users\\bean\\Desktop\\可视化Test\\folium_HeatMap-master\\data\\PM25-20180101.csv")
# 获取数据个数
num = df.shape[0]
# 获取纬度
...
file_path = "C:/Users/bean/Desktop/可视化Test/folium_HeatMap-master/data/AirQualityMap.html"
# 保存为html文件
